...
const BACKEND_CODES = new Set<BackendApiErrorCode>([
  ...
  'PROFORMA_NOT_ISSUED',
  'NOT_FOUND_EXCEPTION', 'STANDARD_PLAN_NOT_FOUND', 'SALES_ORDER_GRANT_NIP_MISMATCH',
  'SALES_ORDER_GRANT_PAYMENT_METHOD_MISMATCH', 'DISCOUNT_NOT_APPLICABLE',
  'WK_CONFIG_PERSONAL_DATA_NOT_SUBMITTED', 'WK_CONFIG_PERSONAL_DATA_MISMATCH',
  'WK_CONFIG_CHECKOUT_INCOMPLETE', 'WK_CONFIG_NOT_IN_PROGRESS',
  'COMPANY_NIP_ALREADY_REGISTERED', 'VALIDATION_FAILED_EXCEPTION',
]);
